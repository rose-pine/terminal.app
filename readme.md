<p align="center">
    ...
    <h2 align="center">Rosé Pine for Terminal.app</h2>
</p>
...
1. In settings, import `rose-pine.terminal` (or open `rose-pine.terminal`)
2. Set profile as default

or

1. In settings, export any profile from the list
2. Replace the contents of the exported profile with `rose-pine.terminal`
